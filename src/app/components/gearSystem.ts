export class GearSystem{
  ...
  runAnimation(){
    ...
    const targets = [this.gear1,this.gear6,this.gear7,this.gearBaseBottom,this.gear8,this.gearBaseLeft,this.gearBaseRight,this.gear3,this.gear2,this.gear4,this.gear5]
